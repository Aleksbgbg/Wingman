namespace Wingman.Container
{
    ...
    /// <summary> Convenience base class for implementing <see cref="IDependencyRetriever"/> and <see cref="IDependencyRegistrar"/>. </summary>
    public abstract class DependencyContainerBase : IDependencyRetriever, IDependencyRegistrar
    {
        /// <inheritdoc/>
